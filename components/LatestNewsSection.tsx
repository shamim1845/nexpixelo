        ...
        <div className="flex flex-col gap-8">
          {latestPosts.map((post) => {
            ...
            return (
              <article
                key={post._id}
                className="grid items-center gap-6 rounded-[43px] bg-[#FFFFFF] px-6 py-6 lg:grid-cols-[1.05fr_1.15fr_auto] md:gap-8 md:px-10 md:py-10"
              >
                <div className="relative min-h-[230px] overflow-hidden rounded-[27px] border-2 border-black aspect-video">
                  <Image
                    src={imageUrl}
                ...
                <div className=" flex flex-col justify-between gap-5">
                  <div>
                    ...
                    <p className="mb-5 inline-flex rounded-[30px] bg-black px-[15px] py-[9px] text-[15px] font-medium text-white">
                      {formatDate(post.publishedAt)}
                    </p>
                    <h3 className="text-[clamp(1.5rem,2.5vw,31px)] leading-[1.7] font-black font-boldonse  text-black">
                      {post.title}
                    </h3>
